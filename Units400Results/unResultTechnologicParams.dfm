object fmResultTechnologicParams: TfmResultTechnologicParams
      ...
      object dbgRocks: TDBGridEh
        ...
        Columns = <
          ...
          item
            ...
            MaxWidth = 80
            MinWidth = 80
            Title.Caption = #1043#1086#1088#1085#1072#1103' '#1084#1072#1089#1089#1072'|'#1055#1086#1083#1077#1079#1085#1086#1077' '#1080#1089#1082#1086#1087#1072#1077#1084#1086#1077'?'
            Width = 80
          end>
      end
  ...
  object quResultRocks: TADOQuery
    ...
    SQL.Strings = (
      'SELECT DISTINCT Id_Rock,Rock,RockIsMineralWealth'
    ...
    object quResultRocksRockIsMineralWealth: TBooleanField
  ...
  object quResultRockParams: TADOQuery
    ...
    Left = 584
    Top = 416
    object quResultRockParamsId_ResultTechnologicRockParam: TAutoIncField
      FieldName = 'Id_ResultTechnologicRockParam'
      ReadOnly = True
    end
    object quResultRockParamsId_ResultShift: TIntegerField
      FieldName = 'Id_ResultShift'
    end
