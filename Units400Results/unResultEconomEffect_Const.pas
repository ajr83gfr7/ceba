...
resourcestring
  ...
  KOEF_SHIHTCHANGE = 'Коэффциент первода сменных показателей к показателям за период';
  ...
  RASHOD_OF_ELECTRIC = 'Расход электроэнергии, кВт*ч';//'Расход электроэнергии, кВт';
  COST_OF_ELECTRIC_1KV = 'Затраты на электроэнергию, тг/смена';//'Стоимость 1 кВт электроэнергии, тг';
