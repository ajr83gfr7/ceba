object fmExcavatorModelEngines: TfmExcavatorModelEngines
  Left = 385
  Top = 172
  Width = 600
  Height = 400
  ...
  Caption = #1052#1072#1088#1082#1080' '#1076#1074#1080#1075#1072#1090#1077#1083#1077#1081' '#1101#1082#1089#1082#1072#1074#1072#1090#1086#1088#1086#1074
  Color = clBtnFace
  ...
  object dbgExcavatorEngines: TDBGrid
    Left = 0
    Top = 72
    Width = 584
    Height = 251
    Align = alClient
    DataSource = fmDM.dsExcavatorEngines
    DefaultDrawing = False
    Options = [dgEditing, dgAlwaysShowEditor, dgTitles, dgIndicator, dgColumnResize, dgColLines, dgRowLines, dgTabs, dgConfirmDelete, dgCancelOnExit]
    PopupMenu = pmExcavatorEngines
    TabOrder = 0
    ...
    TitleFont.Style = []
    OnDrawColumnCell = dbgExcavatorEnginesDrawColumnCell
    Columns = <
      item
        Expanded = False
        FieldName = 'SortIndex'
  ...
  object pmExcavatorEngines: TPopupMenu
    OnPopup = pmExcavatorEnginesPopup
    Left = 240
    Top = 120
